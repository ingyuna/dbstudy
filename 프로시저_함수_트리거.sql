...
-- 문제 세팅
-- BOOK, CUSTOMER, ORDERS 테이블 (DQL_연습문제_sql 참조)
...
-- 2. CUSTOMER 테이블에 주문총액(구매수량 * 책가격)의 10%를 POINT에 더해 준다.
-- 3. BOOK 테이블의 재고를 조절한다.

DROP TABLE proc_order;
...
-- 함수의 확인
SELECT get_total(90) FROM dual;   -- A
